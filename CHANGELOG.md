...
- **Repeat slot insertion state.** Downloaded items already present in the main VRCALoader window now show Add Again while retaining one-click insertion into the next empty or newly created slot.
